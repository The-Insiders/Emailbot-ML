...
def spam_or_ham(data_tup=None):
    data_tup = (
        [('alekhya@gmail.com', 'you won jackpot'), ('charan@gmail.com', 'you won jackpot'),
         ('charan@gmail.com', 'you won jackpot'), ('guru.sai.shreesh@gmail.com', 'you won jackpot'),
         ('tarun@gmail.com', 'hello there')])
